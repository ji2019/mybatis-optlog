...
public interface DataUtils {
	...
	static List<Map<String, Object>> getDelData(JdbcTemplate jdbcTemplate, String sql) {
		try {
	...
	/**
	 */
	static List<Map<String, Object>> getPreUpdateData(JdbcTemplate jdbcTemplate, String sql) {
		try {
			Statement stmt = CCJSqlParserUtil.parse(sql);
