package com.gymexpress.histar.logs.interceptor;
...
import com.gymexpress.histar.logs.annotation.ControllerLogs;
import com.gymexpress.histar.logs.pojo.OptBo;
import com.gymexpress.histar.logs.pojo.OptLogBo;
import com.gymexpress.histar.logs.service.OptLogger;
import com.gymexpress.histar.logs.utils.Utils;
...
public class SimpleLogInterceptor implements HandlerInterceptor {
	...
	@Autowired
	private OptLogger optLogService;
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception e)
		...
		try {
			...
			// 执行将日志写入数据库
			optLogService.add(Arrays.asList(new OptLogBo[] { optLog }));
		} catch (Exception e2) {
